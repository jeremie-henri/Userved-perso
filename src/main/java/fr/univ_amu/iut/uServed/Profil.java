...
public class Profil {
    ...
    private ArrayList<Avis> avisUti;

    public Profil (String _nomUti, String _prenomUti,String _telephoneUti,char _sexeUti , String _adressePostaleUti , String _bioUti , String _statutUti, String _mailUti ,String _dateNaissanceUti) {
        nomUti=_nomUti;
