...
public class Service extends Annonce {
    ...
    public Service(Utilisateur _utilisateur, ModerateurAuto _modAuto,String _intituleAnnonce, String _serviceDemande, String _description, String _connaissancesReq, double _prixService, int _dureeService,String ville) {
        Main.getBD().getTabService().add(this);
        super.ville=ville;
