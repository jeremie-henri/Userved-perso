...
public class Evenement extends Annonce{
    ...
    public Evenement (Utilisateur _utilisateur, ModerateurAuto _modAuto,String _intituleAnnonce,String _lieu, String _activite, int _nombreMaxPers, int _duree, String _equipement, String _date,String ville)
    {
        super.ville=ville;
        ...
        typeAnnonce = "Evenement";
        Main.getBD().addEvenement(this);
    }
